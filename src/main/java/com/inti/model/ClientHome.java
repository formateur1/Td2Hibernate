 ...
 * @see com.inti.model.Client
 * @author Hibernate Tools
 */
public class ClientHome {

	private static final Logger logger = Logger.getLogger(ClientHome.class.getName());
	...
	public Client merge(Client detachedInstance) {
		logger.log(Level.INFO, "merging Client instance");
		try {
	...
	public Client findById(int id) {
		...
		try {
			Client instance = (Client) sessionFactory.getCurrentSession().get("com.inti.model.Client", id);
			if (instance == null) {
	...
	public List findByExample(Client instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.inti.model.Client")
